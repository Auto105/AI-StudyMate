  ...
  mcq: [
    {
      ...
      choices: [
        '프로세스는 실행 중인 프로그램이고 스레드는 프로세스 안의 실행 단위다.',
        '스레드는 항상 독립된 주소 공간을 가진다.',
        '프로세스는 운영체제와 관계없이 실행된다.',
        '스레드는 파일 시스템만 관리한다.',
      ],
      answer: '프로세스는 실행 중인 프로그램이고 스레드는 프로세스 안의 실행 단위다.',
      explanation: '프로세스는 실행 중인 프로그램 단위이며, 스레드는 프로세스 내부의 작업 실행 단위입니다.',
    },
  ],
  ox: [
    {
